...
# AI's that will write in background. joanna_bieri@redlands.edu
...
def path_entry():
    ...
    if e1.get() == "I":
        read_poem_replace("Sonder's_eyes.txt")

    if e1.get() == "will":
        read_poem_replace("Maybe_Cycles.txt")

    if e1.get() == "love":
        read_poem_replace("Prometheus.txt")

    if e1.get() == "you":
        read_poem_replace("Octopi_rain.txt")

    if e1.get() == "if":
        read_poem_replace("Ifs.txt")

    if e1.get() == "wEvBm7":
        read_poem_replace("The_4_0.txt")

    if e1.get() == "never":
        read_poem_replace("The_bind.txt")

    if e1.get() == "see":
        read_poem_replace("Cricket_leg.txt")

    if e1.get() == "e8DwMR":
        read_poem_replace("Blithe_trash.txt")

    if e1.get() == "Dt2xzm":
        read_poem_replace("Child_bird.txt")

    if e1.get() == ",":
        read_poem_replace("Move_appropriately.txt")

    if e1.get() == "and":
        read_poem_replace("No_digas.txt")

    if e1.get() == "VSFGAv":
        read_poem_replace("Rain_remember.txt")

    if e1.get() == "x6UbBB":
        read_poem_replace("Theatre.txt")

    if e1.get() == "ShGBuV":
        read_poem_replace("Cabeza.txt")

    if e1.get() == "4MsVfG":
        read_poem_replace("Jungle.txt")

    if e1.get() == "L6UjcF":
        read_poem_replace("Liquor_apple.txt")

    if e1.get() == "z9Rqux":
        read_poem_replace("Words_house.txt")

    if e1.get() == "rGpVBU":
        read_poem_replace("Aztec.txt")

    if e1.get() == "g6zCvu":
        read_poem_replace("Endgame.txt")

    if e1.get() == "every":
        read_poem_replace("Outerness.txt")

    if e1.get() == "Tuesday":
        read_poem_replace("Raining.txt")

    if e1.get() == "reading":
        read_poem_replace("Ifs.txt")

    if e1.get() == "this":
        read_poem_replace("Maps.txt")

    if e1.get() == "not":
        read_poem_replace("My_mind_similar.txt")

    if e1.get() == "wearing":
        read_poem_replace("Couple_smoked.txt")

    if e1.get() == "a":
        read_poem_replace("Listen_to_the_clouds.txt")

    if e1.get() == "blindfold":
        read_poem_replace("The_function_playground.txt")

    if e1.get() == "mientras":
        read_poem_replace("The_poop_proof.txt")

    if e1.get() == "hay":
        read_poem_replace("Sir.txt")

    if e1.get() == "esperanza":
        read_poem_replace("Set_ignorance.txt")

    if e1.get() == "UK38mz":
        read_poem_replace("Bloody_pen.txt")
