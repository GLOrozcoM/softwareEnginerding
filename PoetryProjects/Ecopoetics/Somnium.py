...
class Somnium:
    ...
    def cataracta(self):
        ...
        # Randomly decide whether the waterfall shall fall to the left or right.
        decide = randint(0, 1)
        ...
        # Th3 conditional dictates whether it is a left or right waterfall.
        if decide == 0:
            for block in self.blocks:

                # Spaces first, then text, then a new line.
                waterfall += left_spaces * " " + block + "\n"
